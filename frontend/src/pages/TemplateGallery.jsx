...
import SmokeMist from "../components/portfolio/templates/Smoke_Mist/index";
...
/>
      ...
      {/* Smoke Mist — sandboxed fixed-nav frame */}
      <div className="mt-12">
        <div className="mb-4 flex items-center gap-3 px-1">
          <span className="rounded-full bg-blue-900/30 px-3 py-1 text-xs font-bold uppercase tracking-widest text-blue-300 border border-blue-800/40">
            〜 Smoke Mist
          </span>
          <h2 className="text-lg font-semibold text-foreground/70">Smoke Mist — Atmospheric Dark / Moody Full Template</h2>
        </div>
        <div className="rounded-2xl border border-blue-900/20"
          style={{ height: 640, overflowY: "auto", overflowX: "hidden", transform: "translate(0)", position: "relative" }}>
          <SmokeMist />
